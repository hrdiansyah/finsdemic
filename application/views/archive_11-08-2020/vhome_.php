...
<?php $this->load->view('iMenu');?>     
      ...
      <section class="section swiper-container swiper-slider swiper-slider-modern" data-loop="true" data-autoplay="5000" data-simulate-touch="true" data-nav="true" data-slide-effect="fade">
        <div class="swiper-wrapper text-left">
          <div class="swiper-slide context-dark" data-slide-bg="<?=base_url()?>assets/vdk/images/slider-1-1920x729.jpg">
            <div class="swiper-slide-caption">
              <div class="container">
                <div class="row justify-content-center justify-content-xxl-start">
                  <div class="col-md-10 col-xxl-6">
                    <div class="slider-modern-box">
                      <h1 class="slider-modern-title"><span data-caption-animate="slideInDown" data-caption-delay="0"><!-- judul slider--></span></h1>
                      <p data-caption-animate="fadeInRight" data-caption-delay="400"><!-- isi slider --></p>
          ...
          <div class="swiper-slide context-dark" data-slide-bg="<?=base_url()?>assets/vdk/images/slider-2-1920x729.jpg">
            <div class="swiper-slide-caption">
              <div class="container">
                <div class="row justify-content-center justify-content-xxl-start">
                  <div class="col-md-10 col-xxl-6">
                    <div class="slider-modern-box">
                      <h1 class="slider-modern-title"><span data-caption-animate="slideInLeft" data-caption-delay="0"><!-- judul slider--></span></h1>
                      <p data-caption-animate="fadeInRight" data-caption-delay="400"><!-- isi slider --></p>
                      <div class="oh button-wrap"><!-- <a class="button button-primary button-ujarak" href="about-us.html" data-caption-animate="slideInLeft" data-caption-delay="400">Read more</a>--></div>
                    </div>
                  </div>
          ...
          <div class="swiper-slide" data-slide-bg="<?=base_url()?>assets/vdk/images/slider-3-1920x729.jpg">
            <div class="swiper-slide-caption">
              <div class="container">
                <div class="row justify-content-center justify-content-xxl-start">
                  <div class="col-md-10 col-xxl-6">
            ...
            <div class="col-sm-6 col-lg-4 wow fadeInRight" data-wow-delay="0s">
              <article class="box-icon-ruby">
                <div class="unit box-icon-ruby-body flex-column flex-md-row text-md-left flex-lg-column align-items-center text-lg-center flex-xl-row text-xl-left">
                  ...
                  <div class="unit-body">
                    <h4 class="box-icon-ruby-title"><a href="#">Bellin Turf</a></h4>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-4 wow fadeInRight" data-wow-delay=".1s">
              <article class="box-icon-ruby">
                <div class="unit box-icon-ruby-body flex-column flex-md-row text-md-left flex-lg-column align-items-center text-lg-center flex-xl-row text-xl-left">
                  ...
                  <div class="unit-body">
                    <h4 class="box-icon-ruby-title"><a href="#">Courts</a></h4>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-4 wow fadeInRight" data-wow-delay=".2s">
              <article class="box-icon-ruby">
                <div class="unit box-icon-ruby-body flex-column flex-md-row text-md-left flex-lg-column align-items-center text-lg-center flex-xl-row text-xl-left">
                  ...
                  <div class="unit-body">
                    <h4 class="box-icon-ruby-title"><a href="#">History</a></h4>
                  </div>
                </div>
              </article>
            </div>
        ...
        <div class="container">
          <div class="row row-40 justify-content-center">
            <div class="col-sm-8 col-md-7 col-lg-6 wow fadeInLeft" data-wow-delay="0s">
              <div class="product-banner"><img src="<?=base_url()?>assets/vdk/images/home-banner-1-570x715.jpg" alt="" width="570" height="715"/>
                <div class="product-banner-content">
                  <div class="product-banner-inner" style="background-image: url(<?=base_url()?>assets/vdk/images/bg-brush.png)">
                    <h3 class="text-secondary-1">Installation</h3>
                    <h2 class="text-primary">Guide</h2>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="oh-desktop">
                    ...
                    <article class="product product-2 box-ordered-item wow slideInRight" data-wow-delay="0s">
                      <div class="unit flex-row flex-lg-column">
                        <div class="unit-left">
                          <div class="product-figure"><img src="<?=base_url()?>assets/vdk/images/product-5-270x280.png" alt="" width="270" height="280"/>
                ...
                <div class="col-sm-6 col-md-12 col-lg-6">
                  <div class="oh-desktop">
                    ...
                    <article class="product product-2 box-ordered-item wow slideInLeft" data-wow-delay="0s">
                      <div class="unit flex-row flex-lg-column">
                        <div class="unit-left">
                          <div class="product-figure"><img src="<?=base_url()?>assets/vdk/images/product-6-270x280.png" alt="" width="270" height="280"/>
                            <div class="product-button"><a class="button button-md button-white button-ujarak" href="#">Add to cart</a></div>
                          </div>
                        </div>
                        <div class="unit-body">
                ...
                <div class="col-sm-6 col-md-12 col-lg-6">
                  <div class="oh-desktop">
                    ...
                    <article class="product product-2 box-ordered-item wow slideInLeft" data-wow-delay="0s">
                      <div class="unit flex-row flex-lg-column">
                        <div class="unit-left">
                          <div class="product-figure"><img src="<?=base_url()?>assets/vdk/images/product-8-270x280.png" alt="" width="270" height="280"/>
                            <div class="product-button"><a class="button button-md button-white button-ujarak" href="#">Add to cart</a></div>
                          </div>
                        </div>
                        <div class="unit-body">
                ...
                <div class="col-sm-6 col-md-12 col-lg-6">
                  <div class="oh-desktop">
                    ...
                    <article class="product product-2 box-ordered-item wow slideInRight" data-wow-delay="0s">
                      <div class="unit flex-row flex-lg-column">
                        <div class="unit-left">
                          <div class="product-figure"><img src="<?=base_url()?>assets/vdk/images/product-7-270x280.png" alt="" width="270" height="280"/>
                            <div class="product-button"><a class="button button-md button-white button-ujarak" href="#">Add to cart</a></div>
                          </div>
                        </div>
                        <div class="unit-body">
      ...
      <section class="section text-center">
        <div class="parallax-container" data-parallax-img="<?=base_url()?>assets/vdk/images/bg-parallax-1.jpg">
      ...
      <section class="section section-md bg-default">
        <div class="container">
          <div class="oh">
            <h2 class="wow slideInUp" data-wow-delay="0s">Products</h2>
          </div>
          <div class="row row-30 justify-content-center">
            <div class="col-md-6 col-lg-4 col-xl-4 wow fadeInRight" data-wow-delay="0s">
              <!-- Team Classic-->
              <article class="team-classic"><a class="team-classic-figure" href="#"><img src="<?=base_url()?>assets/vdk/images/team-1-370x406.jpg" alt="" width="370" height="406"/></a>
            ...
            <div class="col-md-6 col-lg-4 col-xl-4 wow fadeInRight" data-wow-delay=".1s">
              <!-- Team Classic-->
              <article class="team-classic"><a class="team-classic-figure" href="#"><img src="<?=base_url()?>assets/vdk/images/team-2-370x406.jpg" alt="" width="370" height="406"/></a>
                <div class="team-classic-caption">
            ...
            <div class="col-md-6 col-lg-4 col-xl-4 wow fadeInRight" data-wow-delay=".2s">
              <!-- Team Classic-->
              <article class="team-classic"><a class="team-classic-figure" href="#"><img src="<?=base_url()?>assets/vdk/images/team-3-370x406.jpg" alt="" width="370" height="406"/></a>
                <div class="team-classic-caption">
      ...
      <section class="section">
        <div class="parallax-container" data-parallax-img="<?=base_url()?>assets/vdk/images/bg-parallax-2.jpg">
          ...
          <div class="row row-30" data-lightgallery="group">
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="thumbnail thumbnail-mary thumbnail-sm wow slideInLeft" data-wow-delay="0s">
                  <div class="thumbnail-mary-figure"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-1-370x303.jpg" alt="" width="370" height="303"/>
                  </div>
                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="<?=base_url()?>assets/vdk/images/gallery-original-1-1200x800.jpg" data-lightgallery="item"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-1-370x303.jpg" alt="" width="370" height="303"/></a>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="thumbnail thumbnail-mary thumbnail-sm wow slideInUp" data-wow-delay=".1s">
                  <div class="thumbnail-mary-figure"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-2-370x303.jpg" alt="" width="370" height="303"/>
                  </div>
                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="<?=base_url()?>assets/vdk/images/gallery-original-2-1200x800.jpg" data-lightgallery="item"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-2-370x303.jpg" alt="" width="370" height="303"/></a>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="thumbnail thumbnail-mary thumbnail-sm wow slideInRight" data-wow-delay=".0s">
                  <div class="thumbnail-mary-figure"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-3-370x303.jpg" alt="" width="370" height="303"/>
                  </div>
                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="<?=base_url()?>assets/vdk/images/gallery-original-3-800x1200.jpg" data-lightgallery="item"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-3-370x303.jpg" alt="" width="370" height="303"/></a>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Thumbnail Classic-->
                <article class="thumbnail thumbnail-mary thumbnail-sm wow slideInUp" data-wow-delay=".1s">
                  <div class="thumbnail-mary-figure"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-4-370x303.jpg" alt="" width="370" height="303"/>
                  </div>
                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="<?=base_url()?>assets/vdk/images/gallery-original-4-800x1200.jpg" data-lightgallery="item"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-4-370x303.jpg" alt="" width="370" height="303"/></a>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                <!-- Thumbnail Classic-->
                <article class="thumbnail thumbnail-mary thumbnail-sm wow slideInLeft" data-wow-delay="0s">
                  <div class="thumbnail-mary-figure"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-5-370x303.jpg" alt="" width="370" height="303"/>
                  </div>
                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="<?=base_url()?>assets/vdk/images/gallery-original-5-800x1200.jpg" data-lightgallery="item"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-5-370x303.jpg" alt="" width="370" height="303"/></a>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="thumbnail thumbnail-mary thumbnail-sm wow slideInDown" data-wow-delay=".1s">
                  <div class="thumbnail-mary-figure"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-6-370x303.jpg" alt="" width="370" height="303"/>
                  </div>
                  <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="<?=base_url()?>assets/vdk/images/gallery-original-6-1200x800.jpg" data-lightgallery="item"><img src="<?=base_url()?>assets/vdk/images/grid-gallery-6-370x303.jpg" alt="" width="370" height="303"/></a>
