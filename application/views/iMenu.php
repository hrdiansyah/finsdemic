			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
					<div class="responsive_main_logo">	
						<img src="<?=base_url()?>assets/edm/images/header/logo.png" alt="Logo" title="Bizzness Logo">
					</div>	
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				...
				<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
					<div class="event_logo_wrapper">
						<div class="logo_wrapper">
							<a href="./"><img src="<?=base_url()?>assets/edm/images/header/logo.png" alt="Logo" title="Finsdemic - PT. FINANSIA REKA USAHA"></a>
						</div>
					</div>	
				</div>
							...
							<div class="lv_main_menu_wrapper">
								<div class="lv_main_menu lv_single_index_menu">
									<ul>
										...
										<li><a href="3">Schedule</a></li>
										<li><a href="4">Buy</a></li>
										<li><a href="6">Sponsors</a></li>
										<li><a href="8">FAQ’s</a></li>
										<li><a href="7">News</a></li>
										<li><a href="1">About</a></li>
										<li><a href="10">Archive</a></li>
					...
					<div class="col-lg-1 col-md-1 hidden-xs hidden-sm">
						<div class="submit_btn">
							<ul>
								<li><a href="9"><img src="<?=base_url()?>assets/edm/images/header/More.png" alt="more_img"></a></li>
							</ul>
						</div>
					</div>
			</div>
