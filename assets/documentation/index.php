...
<html>
  <head>
    ...
    <title>Matala Consulting Group | Documentation</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../index2.php" class="logo">
          ...
          <span class="logo-lg"><img src="http://matala.id/dev/logo-matala.png" height="70"></span>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              <li><a href="http://matala.id">Matala Consulting Group</a></li>
              <li><a href="http://matala.id/premium">Premium Templates</a></li>
            </ul>
          </div>
        </nav>
      </header>
    ...
    <div class="col-sm-6">
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <a href="http://matala.id/download/AdminLTE-dist" class="btn btn-primary"><i class="fa fa-download"></i> Download</a>
        </div><!-- /.box-body -->
      </div><!-- /.box -->
    </div><!-- /.col -->
    <div class="col-sm-6">
      <div class="box box-danger">
        ...
        <div class="box-body">
          ...
          <a href="http://matala.id/download/AdminLTE" class="btn btn-danger"><i class="fa fa-download"></i> Download</a>
        </div><!-- /.box-body -->
      </div><!-- /.box -->
    </div><!-- /.col -->
  </div><!-- /.row -->
...
<section id="layout">
  ...
  <div class="callout callout-danger lead">
    <h4>Tip!</h4>
    <p>The <a href="../starter.php">starter page</a> is a good place to start building your app if you'd like to start from scratch.</p>
  </div>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Bimo Wikantiyoso</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="../dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                    <p>
                      Bimo Wikantiyoso - Web Developer
      ...
      &LT;ul class="nav navbar-nav">
        ...
        &LT;li class="dropdown user user-menu">
          &LT;a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            &LT;span class="hidden-xs">Bimo Wikantiyoso&LT;/span>
          &LT;/a>
          &LT;ul class="dropdown-menu">
            &LT;!-- User image -->
          ...
          <div class="direct-chat-messages">
            ...
            <div class="direct-chat-msg">
              <div class="direct-chat-info clearfix">
                <span class="direct-chat-name pull-left">Bimo Wikantiyoso</span>
    ...
    &LT;div class="direct-chat-messages">
      ...
      &LT;div class="direct-chat-msg">
        &LT;div class="direct-chat-info clearfix">
          &LT;span class="direct-chat-name pull-left">Bimo Wikantiyoso&LT;/span>
  ...
  <div class="row bring-up">
    ...
    <div class="col-sm-3">
      <ul class="list-unstyled">
        ...
        <li><a href="http://ionden.com/a/plugins/ion.rangeSlider/en.php" target="_blank">Ion Slider</a></li>
    ...
    <div class="col-sm-3">
      <ul class="list-unstyled">
        <li><h4>Other</h4></li>
        <li><a href="https://datatables.net/examples/styling/bootstrap.php" target="_blank">DataTables</a></li>
...
<section id="implementations">
  ...
  <p><b class="text-red">Note:</b> these implementations are not supported by Matala Consulting Group. However,
    they do provide a good example of how to integrate AdminLTE into different frameworks. For the latest release
    of AdminLTE, please visit our <a href="https://github.com/almasaeed2010/AdminLTE">repository</a> or <a href="https://matala.id">website</a></p>
</section>
...
<section id="faq">
  ...
  <p class="lead">The best option is to subscribe to our mailing list using the <a href="http://matala.id/#subscribe">subscription form on Matala Consulting Group</a>.
    If that's not appealing to you, you may watch the <a href="https://github.com/almasaeed2010/AdminLTE">repository on Github</a> or visit <a href="http://matala.id">Matala Consulting Group</a> every now and then for updates and announcements.</p>
</section>
  ...
  <p class="lead">
    ...
    Attribution is not required (though very much appreciated).
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017 <a href="http://matala.id">Matala Consulting Group</a>.</strong> All rights reserved.
      </footer>
